...
from ..models.models import Base, Lancamento, Usuario, Categoria, Subcategoria, Objetivo, ItemLancamento
...
def popular_dados_iniciais(db_session: Session):
    ...
    # Primeiro, vamos criar um usuário padrão para teste
    from ..models.models import Usuario
    from ..core.security import get_password_hash
    
    usuario_teste = db_session.query(Usuario).filter(Usuario.email == "teste@maestro.com").first()
    if not usuario_teste:
        ...
        db_session.commit()
        db_session.refresh(usuario_teste)
        logging.info("Usuário padrão de teste criado.")
