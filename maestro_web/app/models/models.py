...
class Usuario(Base):
    ...
    # --- COLUNAS PARA A APLICAÇÃO WEB ---
    email = Column(String, unique=True, index=True, nullable=True)
    hashed_password = Column(String, nullable=True)
    
    # --- COLUNAS ANTIGAS (AGORA OPCIONAIS) ---
    ...
    chat_history = relationship("ChatHistory", back_populates="usuario", cascade="all, delete-orphan")
...
class ChatHistory(Base):
    ...
    # Relacionamento
    usuario = relationship("Usuario", back_populates="chat_history")